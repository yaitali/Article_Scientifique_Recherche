...
if(!empty($_POST)){
  extract($_POST);
    if(!Utilisateur::recherche($username)){
      $found = false;
      $error_not_found = "Aucun utilisateur n'a été trouvé pour ce pseudonyme : ".$username;
    }else{
      $found = true;
                   ...
                   <thead>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="envoi.php?id=<?php echo $FoundUser->id; ?>">Envoyer Message</a> / <a href="profil.php?id=<?php echo $FoundUser->id; ?>">Profil</a> /
                        <?php
